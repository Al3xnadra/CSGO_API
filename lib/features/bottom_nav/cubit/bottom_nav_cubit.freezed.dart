...
class _$BottomNavStateImpl implements _BottomNavState {
  const _$BottomNavStateImpl({this.selectedTab = 0});
  ...
  @override
  String toString() {
    return 'BottomNavState(selectedTab: $selectedTab)';
  }
...
abstract class _BottomNavState implements BottomNavState {
  const factory _BottomNavState({final int selectedTab}) = _$BottomNavStateImpl;
